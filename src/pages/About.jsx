...
const stats = [
  {
    ...
    icon: BookOpen,
    value: "850 000+",
    label_ru: "Единиц хранения",
    label_kz: "Сақтау бірліктері",
  },
  {
    id: 2,
    icon: Clock,
    value: "25+",
    label_ru: "Лет истории",
    label_kz: "Жыл тарихы",
  },
  {
    id: 3,
    icon: Users,
    value: "150 000+",
    label_ru: "Обслуженных граждан",
    label_kz: "Қызмет көрсетілген азаматтар",
  },
];
...
const departments = [
  {
    ...
    name_kz: "Басшылық",
    desc_ru:
      "Определение стратегических целей архива, координация работы всех подразделений.",
    desc_kz:
      "Мұрағаттың стратегиялық мақсаттарын айқындау, барлық бөлімшелердің жұмысын үйлестіру.",
    icon: User,
  },
  {
    id: 2,
    name_ru: "Отдел формирования фондов",
    name_kz: "Қорларды қалыптастыру бөлімі",
    desc_ru:
      "Поиск, прием и регистрация новых документов, имеющих историческую ценность.",
    desc_kz:
      "Тарихи құндылығы бар жаңа құжаттарды іздеу, қабылдау және тіркеу.",
    icon: FileText,
  },
  {
    id: 3,
    name_ru: "Сектор обслуживания пользователей",
    name_kz: "Пайдаланушыларға қызмет көрсету секторы",
    desc_ru:
      "Работа с запросами граждан, выдача архивных справок и помощь в читальном зале.",
    desc_kz:
      "Азаматтардың сұраныстарымен жұмыс, мұрағаттық анықтамалар беру және оқу залында көмек көрсету.",
    icon: Users,
  },
  {
    id: 4,
    name_ru: "IT-отдел (Техническая поддержка)",
    name_kz: "IT-бөлімі (Техникалық қолдау)",
    desc_ru:
      "Оцифровка документов, поддержка баз данных и внедрение цифровых технологий.",
    desc_kz:
      "Құжаттарды цифрландыру, деректер базасын қолдау және цифрлық технологияларды енгізу.",
    icon: Database,
  },
];
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-xl mb-1">
                    {lang === "ru" ? "Электронные базы" : "Электронды базалар"}
                  </h4>
                  <p className="text-slate-500 dark:text-slate-400">
                    {lang === "ru"
                      ? "Безопасное облачное хранение отсканированных фондов."
                      : "Сканерленген қорлардың қауіпсіз бұлттық қоймасы."}
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-xl mb-1">
                    {lang === "ru" ? "Автоматизация" : "Автоматтандыру"}
                  </h4>
                  <p className="text-slate-500 dark:text-slate-400">
                    {lang === "ru"
                      ? "Мгновенный поиск документов с помощью алгоритмов."
                      : "Алгоритмдер арқылы құжаттарды лезде іздеу."}
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-xl mb-1">
                    {lang === "ru" ? "Интеграция" : "Интеграция"}
                  </h4>
                  <p className="text-slate-500 dark:text-slate-400">
                    {lang === "ru"
                      ? "Доступ к архивным услугам прямо со смартфона."
                      : "Мұрағат қызметтеріне смартфоннан тікелей қол жеткізу."}
                  </p>
                </div>
              </div>
            </div>
            ...
            {departments.map((dept) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3 leading-tight">
                  {lang === "ru" ? dept.name_ru : dept.name_kz}
                </h3>
