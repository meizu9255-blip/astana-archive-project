      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          <div className="space-y-4">
            <Link
              to="/"
              className="flex items-center gap-3 group text-white mb-6"
            >
              <Landmark className="h-10 w-10 text-brand-gold group-hover:scale-105 transition-transform" />
              <div className="flex flex-col text-left justify-center">
                <span className="text-sm md:text-base font-bold text-white leading-tight uppercase">
                  Астана қаласының Мемлекеттік архиві
                </span>
                <span className="text-xs md:text-sm text-yellow-500 whitespace-nowrap leading-tight uppercase">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-4">
              <a
                href="https://www.gosarhiv.kz/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 group bg-white/5 hover:bg-white/10 p-3 rounded-xl transition-all border border-white/10 hover:border-brand-gold/50"
              >
              ...
              <a
                href="https://www.gosarhiv.kz/publikatsii/astana-alasynda-biry-aj-elektrondy-arkhiv-rylady"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 group bg-white/5 hover:bg-white/10 p-3 rounded-xl transition-all border border-white/10 hover:border-brand-cyan/50"
              >
                ...
                <span className="text-sm font-medium text-white/90 group-hover:text-white transition-colors">
                  {lang === "ru"
                    ? "Электронный архив акимата"
                    : "Әкімдіктің электронды архиві"}
                </span>
              </a>
              <a
                href="http://www.gosarhiv.kz/ru/vestnik-arkhiva"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 group bg-white/5 hover:bg-white/10 p-3 rounded-xl transition-all border border-white/10 hover:border-white/50"
              >
            ...
            <p className="text-xs mt-6 text-white/50">{t.footer.schedule}</p>
          </div>
        </div>
