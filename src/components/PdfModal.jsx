...
export default function PdfModal({ isOpen, onClose, pdfUrl, title = 'Документ' }) {
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        >
          ...
          {/* Body (iframe) */}
          <div className="flex-grow bg-slate-200 dark:bg-slate-800 overflow-hidden" style={{ minHeight: '60vh' }}>
            <iframe 
              src={pdfUrl} 
